export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'forexmall',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Forexmall',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'forexmall.net',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://forexmall.net',
